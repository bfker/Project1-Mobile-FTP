...
import com.example.ftp.tools.InnerOperation.askForList
import com.example.ftp.tools.InnerOperation.downLoad
...
import com.example.ftp.tools.InnerOperation.upLoad
import java.io.File
    ...
    private fun master(){
        ...
        commandButton.setOnClickListener(){
            ...
            result = when (commandName) {
                ...
                "RETR" -> downLoad(currentCommand, args)
                "STOR" -> upLoad(currentCommand, args)
